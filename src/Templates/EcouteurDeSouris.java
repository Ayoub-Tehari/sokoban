...
public class EcouteurDeSouris implements MouseListener {
	AireDeDessin2 dessin;
	public EcouteurDeSouris (AireDeDessin2 ad) {
		dessin = ad;
	}
	@Override
	public void mousePressed(MouseEvent e) {
		System.out.println("Le bouton de la souris a ete presse en (" + e.getX() + ", " + e.getY() + ")");
		dessin.setCenter(e.getX(), e.getY());
